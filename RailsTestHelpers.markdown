Items that assist the user during the functional test phase. A good example being: building a logged in user if your create/edit functions require authentication before they will pass
